...
class TestMafColumnRecord(unittest.TestCase):
    ...
    def test_basic_column(self):
        column = MafColumnRecord.build(name="key", value="value", column_index=0, description="Foo Bar")
    ...
    def test_str(self):
        ...
        column = TestMafColumnRecord.NoneColumn(key="key", value=None,
                                                column_index=0,
                                                description="Foo Bar")
        self.assertFalse(column.is_null())
